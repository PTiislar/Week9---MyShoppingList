...
namespace MyShoppingList
{
    class Program
    {
        ...
        {
            string rootDirectory = @"C:\Users\pirgi_8m51456\samples";
            ...
            //string fileLocation = $@"C:\Users\pirgi_8m51456\samples\{newDirectory}";
            //string userFileName = $@"C:\Users\pirgi_8m51456\samples\{newDirectory}\\{fileName}"; 
